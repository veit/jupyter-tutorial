...
`Voilà <https://github.com/QuantStack/voila>`_ wurde von `QuantStack
...
* Voilà unterstützt :doc:`interaktive Jupyter-Widgets
  ...
  :doc:`/jupyter/ipywidgets/libs/bqplot`,
  :doc:`/jupyter/ipywidgets/libs/ipyleaflet`, 
  :doc:`/jupyter/ipywidgets/libs/ipyvolume`, 
