...
#  Default: '/srv/jupyter/.local/share/virtualenvs/hub-TBTLeaau/share/jupyterhub'
# c.JupyterHub.data_files_path = '/srv/jupyter/.local/share/virtualenvs/hub-TBTLeaau/share/jupyterhub'
...
c.JupyterHub.services = [
    {
        ...
        "command": [
            "/srv/jupyter/.local/share/virtualenvs/hub-TBTLeaau/bin/python",
            "-m",
            "nbviewer",
        ],
    }
...
c.SystemdSpawner.mem_limit = "64G"
...
# c.Spawner.cmd = ['/srv/jupyter/.local/share/virtualenvs/hub-TBTLeaau/bin/jupyterhub-singleuser']
